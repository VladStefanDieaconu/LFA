...
%{
 HomeworkSolver solve = new HomeworkSolver();
%}
...
<SRCT> {Name} {
    ...
    solve.addTransitionFrom(yytext());
    yybegin(SEPSST);
}
...
<SYMT> {Symbol} {
    ...
    solve.addTransitionOn(yycharat(0));
    yybegin(SEPSDT);
}
